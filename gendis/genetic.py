...
try:
    ...
    from operators import (merge_crossover, point_crossover,
                           shap_point_crossover, random_merge_crossover, crossover_operator, position_based_crossover)
except:
...
class GeneticExtractor(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, population_size=50, iterations=25, verbose=False, 
                 ...
                 # cx_ops=[random_merge_crossover, point_crossover, shap_point_crossover],
                 # cx_ops=[random_merge_crossover, position_based_crossover],
                 cx_ops=[random_merge_crossover, position_based_crossover, crossover_operator],
